	...
	<div class="container">
		<div class="row">
			<div class="col-xs-3 col-xs-offset-9 contact-number">
				...
				<i class="fa fa-phone"></i> <h3><?php the_field('phone_number', 8 ); ?></h3>
		...
		<div class="row">
			<div class="col-xs-9 gv-logo-nav">
				...
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory');?>/img/gv-logo.gif" width="251" height="90" alt="Greenview Consulting"/></a>
				<nav>
			...
			<div class="col-xs-3">
				...
				<a href="<?php echo home_url(); ?>/#quote" class="btn gv-btn gv-btn-quote col-xs-12">Get a Quote</a>
